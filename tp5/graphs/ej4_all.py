...
ax[0].set_title("1er Tiempo")
ax[1].imshow(heat_map_2f, cmap='RdYlGn_r', interpolation='spline16')
ax[1].set_title("2do Tiempo")
plt.show()

fig, ax = plt.subplots(1, 2, subplot_kw={'xticks': [], 'yticks': []}, constrained_layout = True)
...
fig, ax = plt.subplots(1, 2, subplot_kw={'xticks': [], 'yticks': []}, constrained_layout = True)
ax[0].imshow(heat_map_home_1f[6], cmap='RdYlGn_r', interpolation='spline16')
ax[0].set_title("1er Tiempo")
ax[1].imshow(heat_map_home_2f[6], cmap='RdYlGn_r', interpolation='spline16')
ax[1].set_title("2do Tiempo")
plt.show()

fig, ax = plt.subplots(1, 2, subplot_kw={'xticks': [], 'yticks': []}, constrained_layout = True)
ax[0].imshow(heat_map_away_1f[2], cmap='RdYlGn_r', interpolation='spline16')
ax[0].set_title("1er Tiempo")
ax[1].imshow(heat_map_away_2f[2], cmap='RdYlGn_r', interpolation='spline16')
ax[1].set_title("2do Tiempo")
plt.show()

fig, ax = plt.subplots(1, 2, subplot_kw={'xticks': [], 'yticks': []}, constrained_layout = True)
ax[0].imshow(heat_map_away_1f[0], cmap='RdYlGn_r', interpolation='spline16')
ax[0].set_title("1er Tiempo")
ax[1].imshow(heat_map_away_2f[0], cmap='RdYlGn_r', interpolation='spline16')
ax[1].set_title("2do Tiempo")
plt.show()
