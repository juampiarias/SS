...
ax = plt.imshow(heat_map_home[6], cmap='RdYlGn_r', interpolation='spline16')
ax.axes.xaxis.set_ticks([])
ax.axes.yaxis.set_ticks([])
plt.show()

ax = plt.imshow(heat_map_away[0], cmap='RdYlGn_r', interpolation='spline16')
ax.axes.xaxis.set_ticks([])
ax.axes.yaxis.set_ticks([])
plt.show()

ax = plt.imshow(heat_map_away[2], cmap='RdYlGn_r', interpolation='spline16')
ax.axes.xaxis.set_ticks([])
ax.axes.yaxis.set_ticks([])
plt.show()
